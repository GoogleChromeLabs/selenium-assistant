...
const SafariConfig = require('../webdriver-config/safari');
 ...
 */
class SafariDriverBrowser extends SauceLabsBrowser {
  /**
   ...
   */
  constructor(version) {
    super(new SafariConfig(), version);
  }
...
module.exports = SafariDriverBrowser;
